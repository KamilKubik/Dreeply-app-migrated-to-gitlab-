...
var ProjectsManager = function ProjectsManager(_ref) {
  ...
  var chooseClassesClick = function chooseClassesClick(index) {
    ...
    if (activeClass) {
      gsap__WEBPACK_IMPORTED_MODULE_6__["default"].to(classArrayref.current.find(function (project) {
