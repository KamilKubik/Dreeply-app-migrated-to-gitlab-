      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            setProjects(projectsArray); // let ref = db.collection('projects');
