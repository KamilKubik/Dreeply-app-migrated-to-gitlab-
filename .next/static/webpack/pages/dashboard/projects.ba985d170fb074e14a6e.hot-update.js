            ...
            snapshot.forEach(function (doc) {
              ...
              data.projectUsers.map(function (user) {
                if (user.userUid === userUid) {
                  //   projects.push(data);
                  setProjects(_objectSpread(_objectSpread({}, projects), {}, {
                    data: data
                  }));
                }
              });
