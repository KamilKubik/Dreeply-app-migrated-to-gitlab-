...
const DesktopNavbar = ({ children }) => {
  ...
  useEffect(() => {
    tl.to(manRef.current, {
      ...
      .to(manRef.current, { duration: 3, y: 0, x: 0, ease: Power1.easeInOut });
  }, []);
  ...
  const [activeClass4, setActiveClass4] = useState(false);
  const [activeClass5, setActiveClass5] = useState(false);
  ...
  const [activeHover4, setActiveHover4] = useState(false);
  const [activeHover5, setActiveHover5] = useState(false);
  ...
  const mouseLeaveNav = () => {
    ...
    gsap.to(navRef.current, { width: '80px', ease: Power4.easeOut });
  };

  return (
    <IsActiveContext.Provider value={active}>
      <div className="fixed right-0 z-50" style={{ overflow: 'unset', height: 175 }}>
        <svg width="100" height="100" style={{ overflow: 'unset' }} viewBox="0 0 770 772" xmlns="http://www.w3.org/2000/svg">
          <g>
            <path
            ...
            <path
              ...
              fill="#6C63FF"
            />
            <g style={{ cursor: 'pointer' }} onClick={() => setTheme(theme === 'dark' ? 'light' : 'dark')} ref={manRef}>
              <path
      ...
      {router.pathname.includes('/startup-idea') ||
      router.pathname.includes('/business-plan') ||
      router.pathname.includes('/cash-flow') ||
      router.pathname.includes('/competitors') ? (
        ...
        <div className="h-full w-full overflow-hidden bg-background dark:bg-secondary">
          ...
          >
            ...
            <div className="mt-6 w-52 grid grid-cols-80px items-center">
              <Link href="/dashboard/active-plan">
                <svg
                ...
                >
                  ...
                  <title>Paper plane Message</title>
