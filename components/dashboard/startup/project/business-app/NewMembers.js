...
const NewMembers = ({ projectId }) => {
  return (
    <div className="z-50 text-primarydark rounded-2xl mb-32 flex flex-col transform hover:scale-105 hover:-translate-y-2 hover:-translate-x-2 transition duration-500 ease-in-out">
      <div className="flex">
