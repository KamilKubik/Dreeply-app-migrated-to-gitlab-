        ...
        visible && (
          <div ref={tippyRef} className="h-32 w-80 shadow-lg rounded-2xl bg-primary flex justify-center items-center focus:outline-none">
            <p className="p-4 text-sm text-center text-white flex justify-center items-center">
              The startup idea creator will guide you through the entire process of creating your business plan. Start growing your project,
              without any special business knowledge!
            </p>
          </div>
        )
      }
