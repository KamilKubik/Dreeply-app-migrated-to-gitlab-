...
const StartupMarketModal = () => {
  ...
  const onSubmit = async (e) => {
    ...
    setTimeout(() => {
      router.push('/dashboard/startup/creator/finances');
    }, 1200);
  ...
  const marketOverviewSectionData = marketOverviewSection
    ? marketOverviewSection
    : 'blank';
  const competitorsSectionData = competitorsSection
    ? competitorsSection
    : 'blank';
  const targetCustomersSectionData = targetCustomersSection
    ? targetCustomersSection
    : 'blank';
  const competitionDistinguishSectionData = competitionDistinguishSection
    ? competitionDistinguishSection
    : 'blank';
  ...
  const onProjectLeave = async (e) => {
    ...
    setTimeout(() => {
      router.push('/dashboard/startup/creator/product');
    }, 1200);
    await db
      .collection('currentProject')
      .doc(currentUser.uid)
              ...
              <div className='relative flex flex-col h-full w-full flex px-8 pt-8 pb-4'>
                ...
                <div className='mt-12'>
                  ...
                  <textarea
                    ...
                    value={
                      competitorsSection == 'blank' ? '' : competitorsSection
                    }
                ...
                <div className='mt-12 pb-8'>
                  <label
                    ...
                    htmlFor='distinguish'
                  >
                    Factors that differentiate your product from the
                    competition.
                    <TippyGuide
                      contentClass='w-80 shadow-lg rounded-2xl bg-primary'
                      contentText={
                  ...
                  <textarea
                    ...
                    id='distinguish'
                    onChange={(e) =>
                      setCompetitionDistinguishSection(e.target.value)
                    }
                    value={
                      competitionDistinguishSection == 'blank'
                        ? ''
                ...
                <div className='mt-12 pb-8'>
                  <label
                    className='block text-sm font-medium flex justify-between items-center'
                    htmlFor='customers'
                  >
