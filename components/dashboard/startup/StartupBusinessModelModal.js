...
const StartupProductModal = () => {
  ...
  const onSubmit = async (e) => {
    ...
    setTimeout(() => {
      router.push('/dashboard/startup/creator/success');
    }, 1200);
  ...
  const businessModelOverviewSectionData = businessModelOverviewSection
    ? businessModelOverviewSection
    : 'blank';
  const businessGrowSectionData = businessGrowSection
    ? businessGrowSection
    : 'blank';
              ...
              <div className='relative flex flex-col h-full w-full flex px-8 pt-8 pb-4'>
                <div>
                  ...
                  <textarea
                    ...
                    onChange={(e) =>
                      setBusinessModelOverviewSection(e.target.value)
                    }
                    value={
                      businessModelOverviewSection == 'blank'
                        ? ''
                ...
                <div className='mt-12'>
                  ...
                  <textarea
                    ...
                    value={
                      businessGrowSection == 'blank' ? '' : businessGrowSection
                    }
                ...
                <div className='mt-12 pb-8'>
                  ...
                  <textarea
                    ...
                    value={
                      whySuccessSection == 'blank' ? '' : whySuccessSection
                    }
                    className='pb-24 px-3 shadow appearance-none rounded w-full py-3 px-4 text-primarydark leading-tight focus:outline-none focus:shadow-outline text-sm bg-white rounded-2xl mt-2'
                    type='textarea'
                    placeholder={
