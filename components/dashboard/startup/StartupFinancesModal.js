...
const StartupProductModal = () => {
  ...
  const startupCostsSectionData = startupCostsSection
    ? startupCostsSection
    : 'blank';
  const runningCostsSectionData = runningCostsSection
    ? runningCostsSection
    : 'blank';
              ...
              <div className='relative flex flex-col h-full w-full flex px-8 pt-8 pb-4'>
                <div>
                  ...
                  <textarea
                    ...
                    value={
                      startupCostsSection == 'blank' ? '' : startupCostsSection
                    }
                ...
                <div className='mt-12'>
                  ...
                  <textarea
                    ...
                    value={
                      runningCostsSection == 'blank' ? '' : runningCostsSection
                    }
