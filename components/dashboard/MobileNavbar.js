...
const MobileNavbar = ({ children }) => {
  ...
  const onMenuClick = () => {
    ...
    if (!menuHelper) {
      gsap.to(navbarMainContainer, { height: navbarHeight, duration: 1, ease: Linear });
      setMenuHelper(true);
    } else if (menuHelper) {
      gsap.to(navbarMainContainer, { height: 48, duration: 1, ease: Linear });
      setMenuHelper(false);
    }
  };
  ...
  return (
    <div>
      <div className="fixed right-0 z-50" style={{ overflow: 'unset', height: 'fit-content' }}>
        <svg
          onClick={() => setTheme(theme === 'dark' ? 'light' : 'dark')}
          width="100"
          height="100"
          style={{ overflow: 'unset', cursor: 'pointer' }}
          viewBox="0 0 770 772"
      ...
      >
        <div id="navbarIcon" className="w-full flex justify-between items-center mt-6">
          <Image onClick={onMenuClick} src="/mobile-navbar/menu.svg" height={20} width={20} />
        </div>
        <div id="navbarContainer" className="w-full flex flex-wrap">
          {/* PDF Section */}
          ...
          <div id="linkSection" className="w-full justify-start items-center mt-4">
            <p>Share your work with this public link:</p>
          ...
          {/* Welcome */}
          <div className="w-full flex items-center mt-4 border-l border-primary pl-2">
            ...
            <Link href="/dashboard/welcome">
              <p className="ml-4">Welcome</p>
            </Link>
          </div>
          {/* Startup */}
          <div className="w-full flex items-center mt-6 border-l border-primary pl-2">
            ...
            <Link href="/dashboard/startup">
              <p className="ml-4">Startup idea</p>
            </Link>
          </div>
          ...
          <div className="w-full flex items-center mt-6 border-l border-primary pl-2">
            ...
            <p className="ml-4">Motivational stories</p>
          </div>
          {/* Account */}
          <div className="w-full flex items-center mt-6 border-l border-primary pl-2">
